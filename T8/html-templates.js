    ...
    <html>
        ...
        <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
            <div class="w3-row w3-margin-bottom">
                ...
                <div class="w3-col s9 w3-border" id="desc_div">
            ...
            <div class="w3-row w3-margin-bottom">
                ...
                <div class="w3-col s9 w3-border" id="inputs">
            ...
            <div>
                ...
                <button class="w3-btn w3-blue-grey" type="button" onclick='moreFileInputs()'}"> More Files </button>
            </div>
        </form>
